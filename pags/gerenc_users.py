...
hidden()
aplicar_tema("usuarios")

cabecalho("Gerenciamento de usuários", "Crie acessos, ajuste perfis, remova usuários e resete senhas da equipe.")

pills = st.pills(label="Ação", label_visibility="collapsed", options=["Criar Usuário", "Editar Usuário", "Excluir Usuário", "Resetar Senha"])
